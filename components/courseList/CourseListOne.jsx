...
export default function CourseListOne() {
  const courseData = [
    {
      ...
      difficulty: "Easy",
      desc:
        "Introductory course on web hosting, domain registration, and how you can easily publish and edit your website online.",
    },
  ];
  ...
  useEffect(() => {
    ...
    axios
      ...
      .then(function(response) {
        ...
        const Data = coursesArray.map((course) => ({
          id: course.id,
          imageSrc: "/assets/img/courses/" + course.imageSrc,
          // imageSrc: "/assets/img/coursesCards/6.png",
          authorImageSrc: "/assets/img/general/avatar-1.png",
          title: course.title,
          rating: 4.3,
  ...
  function addToCart(value) {
    axios
      .post("/api/users/shoplist/" + value, value, config)
      .then(function(response) {
                  ...
                  <div className="sidebar__item">
                    <div className="accordion js-accordion">
                      ...
                      >
                        ...
                        >
                          <h5 className="sidebar__title">카테고리</h5>
                  ...
                  <div className="sidebar__item">
                    <div className="accordion js-accordion">
                      ...
                      >
                        ...
                        >
                          <h5 className="sidebar__title">평점</h5>
                   ...
                   <div className="sidebar__item">
                    <div className="accordion js-accordion">
                      ...
                      >
                        ...
                        >
                          <h5 className="sidebar__title">강사</h5>
                    ...
                    >
                          ...
                          <div className="coursesCard-footer">
                            ...
                            <div className="coursesCard-footer__price">
                              {elm.paid ? (
                                <>
                                  <div>
                                    {elm.originalPrice.toLocaleString()}원
                                  </div>
                                  {/**
                                           <div>{elm.discountedPrice.toLocaleString()}₩</div>
                                           */}
                                </>
                              ) : (
                                <>
                      ...
                      <div className="side-content__item">
                        <div className="px-30 pt-20 pb-30 bg-white rounded-8 border-light shadow-2">
                          ...
                          <p className="text-dark-1 mt-15">{elm.desc}</p>
                          <div className="col">
                              <button
